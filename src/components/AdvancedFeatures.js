        ...
        <AnimatedComponent>
          <Grow style={{ transformOrigin: "0 0 0" }} {...{ timeout: 500 }}>
            <div className="w-full bg-gradient-to-r from-[#e346ff] to-[#00c6ff] border border-solid border-transparent overflow-hidden rounded-[8px] bg-[#0a0a0a] relative p-[1px]">
              <div className="w-full bg-[#0a0a0a] rounded-[7px] p-12">
                <div className="grid md:grid-cols-2 gap-12 relative">
                  {/* Left side - AI Predictions */}
                  <div className="flex flex-col">
                    <h3 className="text-white text-2xl font-sora font-normal text-center mb-6 relative">
                    ...
                    <p className="text-white text-lg font-light leading-relaxed text-left opacity-90">
